...
\paragraph{\hyperref[c6]{Chapter 6 (Online Stabilization of the Planned Motions)}} presents a two-step validation of the physical compliance of the planned motions where an online stabilization is applied to track the optimal trajectories, first in a real-time physics simulation and following up in real-world experiments on a full-size humanoid robot.
\paragraph{\hyperref[c8]{Chapter 7 (Conclusion and Outlook)}} presents the summary of the thesis and identifies future research directions. 
