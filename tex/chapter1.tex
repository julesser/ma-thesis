...
%The framework can be used in one of two ways: Either offline, where a stabilizing controller is build around the nominal trajectory or in a \gls{MPC} sense, where the optimal trajectory is (re-)computed online. 
