...
\section{Foundations of Bipedal Locomotion}\label{sec:BackgroundBiped}
...
\section{Stability Analysis: Not Falling Down}\label{sec:BackgroundStability}
...
\section{Differential Dynamic Programming (DDP)}\label{sec:BackgroundDDP}
...
\section{Handling Constraints with DDP}\label{sec:BackgroundConstrainedDDP}
