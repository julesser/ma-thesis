...
\subsection{Slow Dynamic Walking}
\subsection{Fast Dynamic Walking}
...
\chapter{Validation in Real-Time Physics Simulation}
\section{Simulation Setup}
\subsection{PyBullet Simulation Environment}
\subsection{Spline Interpolation of the Trajectories}
\subsection{Control Approach}
\section{Motion Stabilization with Joint Space Control}
\subsection{Quasi-Static Movements}
\subsection{Bipedal Walking Variants}
\subsection{Highly-Dynamic Movements}

\chapter{Validation in Real-World Experiments}
...
\section{Experiment I: Fast Squats}
\section{Experiment II: One-Leg Balancing}
\section{Experiment III: Static Walking}
\section{Experiment IV: Dynamic Walking}
