...
\usepackage[acronym,nonumberlist,nopostdot]{glossaries} % acronym option für seperates Glossar und Abkürzungsliste -> sonst zusammen
...
\input{tex/_glossary_data}			%include .tex data with definitions 
\usepackage{cleveref}
\captionsetup[subfigure]{subrefformat=simple,labelformat=simple}
%%%%%%%% Hints for glossary:
%%%%%%% main.tex needs to be updated manually with "makeglossaries bachelor_thesis" in console %%%%%%
...
%\section{Validation of Trajectories}
